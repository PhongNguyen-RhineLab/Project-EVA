...
train_dataset = EmotionDataset(
    audio_dir="/kaggle/working/EVA_Dataset/processed_audio",
    label_file="/kaggle/working/EVA_Dataset/labels/train_labels.csv",
    sr=CONFIG['sr'],
...
val_dataset = EmotionDataset(
    audio_dir="/kaggle/working/EVA_Dataset/processed_audio",
    label_file="/kaggle/working/EVA_Dataset/labels/val_labels.csv",
    sr=CONFIG['sr'],
    n_mels=CONFIG['n_mels'],
    duration=CONFIG['duration'],
    hop_length=CONFIG['hop_length'],
...
test_dataset = EmotionDataset(
    audio_dir="/kaggle/working/EVA_Dataset/processed_audio",
    label_file="/kaggle/working/EVA_Dataset/labels/test_labels.csv",
    sr=CONFIG['sr'],
    n_mels=CONFIG['n_mels'],
    duration=CONFIG['duration'],
    hop_length=CONFIG['hop_length'],
